            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-12 py-3.5 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                                value={password}
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <button className="flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 py-3.5 rounded-2xl transition-all font-medium text-sm">
                ...
                <p className="text-center mt-10 text-zinc-500 text-sm">
                    ...
                    <Link href="/signup" title="Go to Signup" className="text-white font-bold hover:text-blue-500 transition-colors">Sign up</Link>
                </p>
            </motion.div>
